...
parser.add_argument('--moco-k-ratio', default=1.0, type=float,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    log_file = os.path.join(save_folder, "output.csv")
    log_buffer = open(log_file, "w")
    log_buffer.write("Epoch, loss, top1 accuracy\n")
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if epoch > 100:
                if epoch >= 195:
                    ...
                    }, is_best=False, folder=save_ckpt_folder, epoch=epoch)
                elif epoch % 5 == 0:
                    save_checkpoint({
                        'epoch': epoch + 1,
                        'arch': args.arch,
